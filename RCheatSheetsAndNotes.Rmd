...
# The answer was the diagnostic plots looked about he same, but they looked worse to me.
# original scale
ggplot(data=wblake, aes(y=Scale, x=Length)) +
  geom_point(col=rgb(.2,.2,.2,.2)) + 
  scale_y_continuous(n.breaks = 7) +
...
predict(wb.lm, data.frame(Length=250),
        interval="prediction")
predict(wb.lm.sqrt, data.frame(Length=sqrt(250)),
        interval="prediction")


#### CLASS ACTIVITY linear model summary due April 6th
