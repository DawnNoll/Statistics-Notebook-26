...
*  Q-Q Plot of Residuals (which=2), least important (for assump 2, close to line)
...
While the slope and intercept are often still meaningful when the independence assumption is violated, the residual standard error is unnecessarily large in this case.Can be checked when the data has natural ordering to it<br>
