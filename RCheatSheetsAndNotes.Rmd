...
calculate_t <- function(estimate, std_error, number=0){
...
t-value measures the size of the difference relative to the variation in your sample-- it is the difference represented in units of standarad error. A t-test puts the tsvalue in context of the calculated t-distribution so you can derive a probability.
